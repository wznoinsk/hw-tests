...
class ServersWithSpecificFlavorTestJSON(base.BaseV2ComputeAdminTest):
    ...
    def test_assign_single_pci_to_instance(self):
        ...
        for info in self.infoList:
            ...
            # better not rely on personality as it depends on nova to have it enabled + image used to work with
            # libguestfs - see note re rc.local in common/pci.py
            # personality = []
            personality = [
                {'path': "/etc/rc.local",
                 'contents': cont}]
            ...
            # print "debug: cirros@" + addresses["addresses"]["private"][0]["addr"]
